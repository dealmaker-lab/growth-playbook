...
const data = [
  ...
  { keyword: 'Competitor', x: 55, y: 52, size: 13, fill: 'rgba(0,244,244,.5)', stroke: CYN },
  { keyword: 'Long-tail', x: 20, y: 72, size: 9, fill: 'rgba(244,203,0,.5)', stroke: YLW },
  { keyword: 'Discovery', x: 50, y: 30, size: 16, fill: 'rgba(176,176,176,.5)', stroke: GRY },
];
  ...
  useEffect(() => {
    ...
    chart
      ...
      .scale('color', {
        ...
        range: ['rgba(38,190,129,.6)', 'rgba(175,156,255,.6)', 'rgba(0,244,244,.5)', 'rgba(244,203,0,.5)', 'rgba(176,176,176,.5)'],
      })
      .axis('x', {
        title: 'Search Volume',
        titleFontSize: 11,
      ...
      .tooltip((d: { keyword: string; x: number; y: number; size: number }) => ({
        name: d.keyword,
