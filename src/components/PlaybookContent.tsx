    ...
    <>
      ...
      <nav className="top-nav" id="topNav">
        <a href="https://appsamurai.com" className="nav-logo" target="_blank" rel="noopener noreferrer">
          <img src="https://appsamurai.com/wp-content/uploads/2022/05/AppSamurai_Black-Green-Logo.png" alt="AppSamurai" style={{ height: '28px', width: 'auto' }} />
        </a>
        ...
        <div className="wrap">
          <div className="footer-grid">
            <div className="footer-brand">
              <img src="https://appsamurai.com/wp-content/uploads/2022/05/AppSamurai_Black-Green-Logo.png" alt="AppSamurai" style={{ height: '28px', width: 'auto', marginBottom: '12px' }} />
